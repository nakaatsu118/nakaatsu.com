  ...
  return (
    <div className={styles.biographyWrapper}>
      <Card>
        <motion.div>
          <CardHeader
            iconPath="/images/biography.webp"
            iconAlt="biography"
            title="Biography"
          />
          <div className={styles.biographyContainer}>
            ...
            >
              <div className={styles.history}>
                ...
                <p className={styles.description}>
                  SIer企業に入社。インターネット決済システムの設計、試験を担当。
                </p>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              <div className={styles.history}>
                ...
                <p className={styles.description}>
                  いちから株式会社（現ANYCOLOR株式会社）に入社。WEBフロント開発、サーバーサイド、社内システム、LP制作・監修、PMなどを担当。
                </p>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              <div className={styles.history}>
                ...
                <p className={styles.description}>
                  freee株式会社に入社。申告システムの機能追加や改修をフルスタックで担当。
                </p>
              </div>
            </motion.div>
            <motion.div
              ...
              initial={{ x: '-100%', opacity: 0 }}
              whileInView={{ x: 0, opacity: 1 }}
              transition={{ duration: 0.1, delay: 0.1, type: 'tween' }}
              viewport={{ margin: '80px' }}
            >
              <div className={styles.history}>
